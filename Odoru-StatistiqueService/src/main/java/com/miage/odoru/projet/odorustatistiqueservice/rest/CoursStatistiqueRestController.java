...
public class CoursStatistiqueRestController {
    ...
    @GetMapping("cours/{idcours}/creneau/{idcreneau}/presence")
    public StatistiqueCoursEleveTransient getCoursPresence(@PathVariable("idcours") Long idCours, @PathVariable("idcreneau") Long idCreneau) throws FeignException {
        // Retourne la statistique de présence pour le cours
